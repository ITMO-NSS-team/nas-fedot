...
def preprocess_save_images():
    ...
    with open('../../dataset_files/labels.json', 'w') as fp:
        json.dump(labels_dict, fp)
    with open('../../dataset_files/encoded_labels.json', 'w') as fp:
        json.dump(encoded_labels, fp)
    with open('../../dataset_files/counted_classes.json', 'w') as cc:
        json.dump(classes_counter, cc)

    write_labels = open('../../dataset_files/all_possible_labels.txt', 'w')
